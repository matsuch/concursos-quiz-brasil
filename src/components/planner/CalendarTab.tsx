...
const BORDER_COLORS = [{
  ...
  value: 'hsl(var(--secondary) / 0.8)'
}, {
  name: 'Destructive Light',
  value: 'hsl(var(--destructive) / 0.8)'
}, {
  name: 'Success Light',
  value: 'hsl(var(--success) / 0.8)'
}, {
  name: 'Accent Light',
  value: 'hsl(var(--accent) / 0.8)'
}, {
  name: 'Muted Light',
  value: 'hsl(var(--muted) / 0.8)'
}, {
  name: 'Blue Light',
  value: 'hsl(217 91% 60%)'
}, {
  ...
  return <div className="space-y-6">
          ...
          <DialogContent className="sm:max-w-lg max-h-[85vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label>Início *</Label>
                  <Input type="datetime-local" value={formData.start_time} onChange={e => setFormData({
                  ...formData,
                ...
                <div>
                  <Label>Fim *</Label>
                  <Input type="datetime-local" value={formData.end_time} onChange={e => setFormData({
                  ...formData,
              ...
              <div>
                ...
                <div className="flex gap-2 flex-wrap mt-2">
                  {THEME_COLORS.map(color => <button key={color.value} type="button" className={cn("w-8 h-8 rounded-full border-2 transition-transform hover:scale-110", formData.color === color.value ? "border-foreground ring-2 ring-primary/30" : "border-transparent")} style={{
              ...
              })} placeholder="Adicione anotações, links, etc." rows={3} />
              </div>
              <div className="flex gap-2 pt-2">
                ...
                {isEditing && <Button variant="destructive" onClick={handleDelete} disabled={deleteCalendarEvent.isPending}>
      ...
      <div className="bg-card rounded-2xl border shadow-sm p-4 sm:p-6">
        <div className="h-[600px]">
          ...
          height: '100%'
        }} view={view} onView={setView} date={date} onNavigate={setDate} onSelectSlot={handleSelectSlot} onSelectEvent={handleSelectEvent} selectable messages={{
          next: 'Próximo',
          previous: 'Anterior',
          today: 'Hoje',
          month: 'Mês',
